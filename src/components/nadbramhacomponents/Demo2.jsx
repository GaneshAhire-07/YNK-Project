    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          table: [
            { description: "Wire Sizes: i. 4.5 mm (for main line)" },
            {
              description:
                "Wire Sizes: ii. 2.5mm (for 16amp points and Main Board lights)",
            },
            {
              description:
                "Wire Sizes: iii. 1.5mm (for remaining all electrical Work)",
            },
            { description: "Wire Sizes: iv. CCTV Wire 4+1 (D-Link White)" },
            { description: "Wire Sizes: v. Speaker wire" },
            { description: "Switch Boards (Ligrand, Anchor, Colour in White)" },
            {
              description:
        ...
        },
        {
          ...
          table: [
            ...
            { description: "Water Tank Inlet" },
            { description: "Water Tank Overflow" },
            {
              description:
                "Water Tank Outlet: - 1 inch and convert at end point with ¾",
            },
            {
              description:
                "Water tank separate connection - 1) To sink (UPVC material), 2) To steamer",
            },
            { description: "Steamer: - from ceiling CPVC ¾ + NRV valve" },
            { description: "Steamer Outlet: - CPVC ¾ inch" },
            { description: "Shop Drainage Outlet: - 3 inch" },
          ],
        },
        {
        ...
        {
          title: "Internet",
          table: [{ description: "Above 50MBPS (1 year package)" }],
        },
        {
        ...
        },
        {
          title: "Gas Pipeline",
          table: [
            { description: "Pipe material – GI material" },
            { description: "Pipe company – Jindal" },
            { description: "Pipe size - 1/2 inch" },
          ],
        },
        {
          title: "Rolling Shed",
          table: [
            { description: "Rolling shed colour – Plain Black" },
            { description: "Zallar - 6” front full plain" },
          ],
        },
        {
          title: "Ducting Work",
          table: [
            { description: "Ducting Work: Yes / No" },
            { description: "Duct pipe size: 14x14" },
            { description: "Hood size: As per kitchen area" },
            { description: "Exhaust fan: 18” compulsory" },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          table: [
            ...
            { description: "वॉल टाईल्स क्षैतिज स्वरूपात लावाव्या" },
          ],
        },
        {
        ...
        },
        {
          ...
          table: [
            { description: "वायर आकार: i. 4.5 मिमी (मुख्य लाइनसाठी)" },
            {
              description:
                "वायर आकार: ii. 2.5 मिमी (16 अँप पॉइंट्स आणि मुख्य बोर्ड लाइट्ससाठी)",
            },
            {
              description:
                "वायर आकार: iii. 1.5 मिमी (उर्वरित सर्व इलेक्ट्रिकल कामासाठी)",
            },
            { description: "वायर आकार: iv. CCTV वायर 4+1 (डी-लिंक पांढरा)" },
            { description: "वायर आकार: v. स्पीकर वायर" },
            { description: "स्विच बोर्ड (लिग्रँड, अँकर, रंग पांढरा)" },
            {
              description:
        ...
        },
        {
          ...
          table: [
            ...
            { description: "पाण्याची टाकी इनलेट" },
            { description: "पाण्याची टाकी ओव्हरफ्लो" },
            {
              description:
                "पाण्याची टाकी आउटलेट: - 1 इंच आणि शेवटच्या बिंदूवर ¾ मध्ये रूपांतर",
            },
            {
              description:
                "पाण्याची टाकी स्वतंत्र कनेक्शन - 1) सिंकला (यूपीव्हीसी मटेरियल), 2) स्टीमरला",
            },
            {
              description: "स्टीमर: - छतापासून सीपीव्हीसी ¾ + एनआरव्ही व्हॉल्व",
            },
            { description: "स्टीमर आउटलेट: - सीपीव्हीसी ¾ इंच" },
            { description: "शॉप ड्रेनेज आउटलेट: - 3 इंच" },
          ],
        },
        {
          title: "CCTV साहित्य",
        ...
        {
          title: "इंटरनेट",
          table: [{ description: "50MBPS पेक्षा जास्त (1 वर्षाचा पॅकेज)" }],
        },
        {
        ...
        },
        {
          title: "गॅस पाइपलाइन",
          table: [
            { description: "पाइप मटेरियल – जीआय मटेरियल" },
            { description: "पाइप कंपनी – जिंदाल" },
            { description: "पाइप आकार - 1/2 इंच" },
          ],
        },
        {
          title: "रोलिंग शेड",
          table: [
            { description: "रोलिंग शेड रंग – साधा काळा" },
            { description: "झालर - 6” समोर पूर्ण साधा" },
          ],
        },
        {
          title: "डक्टिंग काम",
          table: [
            { description: "डक्टिंग काम: होय / नाही" },
            { description: "डक्ट पाइप आकार: 14x14" },
            { description: "हूड आकार: किचन क्षेत्रानुसार" },
            { description: "एक्झॉस्ट फॅन: 18” अनिवार्य" },
          ],
        },
      ],
    },
