...
const Demo1 = () => {
  ...
  const translations = {
    en: {
      ...
      footerSign: "SIGN & MO",
      declaration:
        "I am going to do all the work of my site personally. Visited my branch and explained the site26. I have understood the plan properly. However, all the materials required for my site work have been asked by YNK Company to use the following qualities and brands. Similarly, I am going to complete all the work of my branch using all the materials. Apart from the following material, I will not use the material of any other company.",
      sections: [
        {
